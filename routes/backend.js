...
// Your code for creating a table goes here
        ...
        if (create) {
          ...
          CREATE TABLE IF NOT EXISTS ntctable (
...
// Your code for retrieving data goes here
              ...
              const tableName = 'ntctable'; // Replace with the name of the table to delete
...
// Your code for retrieving Table From database goes here
              ...
              const query = 'SELECT * FROM ntctable'; // Replace with your table name
